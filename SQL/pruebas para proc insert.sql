...
PRE-POST (SILLA en salon original disponible)
...
DELETE FROM RINDE WHERE nro_silla_asignada = 2;
...
INSERT INTO rinde VALUES (1, 3, 'inst1', 1, to_date('2011/01/01', 'yyyy/mm/dd'), 2);

---------


PRE-POST  (NUEVO SALON MISMA SILLA)
Prueba de estudiante nueva rinde para salon 1 y silla 2, +> debe insertar en el salon 2 silla 2
INSERT INTO rinde VALUES (1, 3, 'inst1', 1, to_date('2011/01/01', 'yyyy/mm/dd'), 2);
exito
---------

PRE  (CUALQUIER SALON, CUALQUIER SILLA)
cualquier silla y cualquier salon, si busco registrarme en salon 2 silla 2 
INSERT INTO rinde VALUES (1, 3, 'inst1', 2, to_date('2011/01/01', 'yyyy/mm/dd'), 1);
